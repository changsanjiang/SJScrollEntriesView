#
#  Be sure to run `pod spec lint SJScrollEntriesView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of SJScrollEntriesView."
  ...
  s.homepage     = "http://EXAMPLE/SJScrollEntriesView"
  ...
  s.source       = { :git => "http://EXAMPLE/SJScrollEntriesView.git", :tag => "#{s.version}" }
